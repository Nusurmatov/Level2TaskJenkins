...
namespace ProjectStructure.Pages
{
    public class SearchResultPage : AbstractPage
    {
        ...
        public SearchResultPage(Browser browser = Browser.Chrome) : base(browser) { }
        ...
        public IReadOnlyCollection<IWebElement> Names
        {
            get
            {
                ...
                return base.Driver.FindElements(NamesLocator);
            }
        }
        ...
        public IReadOnlyCollection<IWebElement> PlatformContainer
        {
            get 
            {
                ...
                return base.Driver.FindElements(PlatformContainerLocator);
            }
        }
        ...
        public IReadOnlyCollection<IWebElement> ReleaseDates
        {
            get 
            {
                ...
                return base.Driver.FindElements(ReleaseDatesLocator);
            }
        }
        ...
        public IReadOnlyCollection<IWebElement> ReviewSummaries
        {
            get
            {
                ...
                return base.Driver.FindElements(ReviewSummariesLocator);
            }
        }
        ...
        public IReadOnlyCollection<IWebElement> Prices
        {
            get
            {
                ...
                return base.Driver.FindElements(PricesLocator);
            }
        }
