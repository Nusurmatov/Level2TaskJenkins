...
{
    public class PrivacyPolicyPage : AbstractPage
    {
        ...
        public PrivacyPolicyPage(Browser browser = Browser.Chrome) : base(browser) { }
        ...
        public IReadOnlyCollection<IWebElement> SupportedLanguages
        {
            get
            {
                ...
                return base.Driver.FindElements(SupportedLanguagesLocator);
            }
        }
